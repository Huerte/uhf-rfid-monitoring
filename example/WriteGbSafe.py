...
if __name__ == '__main__':
    ...
    if g_client.openTcp(("192.168.1.168", 8160)):
        ...
        # Antenna 1: Write to EPC area, starting address 2(word) 0-1 deactivate password  2-3 lock password
        epc = MsgBaseWriteGb(antennaEnable=1, area=0x20, start=2, hexWriteData=data)
